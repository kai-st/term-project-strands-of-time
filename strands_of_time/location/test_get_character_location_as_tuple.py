...
class TestGetCharacterLocationAsTuple(TestCase):
    ...
    def test_get_character_location_as_tuple_returns_tuple(self):
        ...
        actual = type(
            strands_of_time.character.character.get_character_location_as_tuple(test_character))
        expected = type((0, 0))
    ...
    def test_get_character_location_as_tuple_X_at_index_0(self):
        ...
        location = strands_of_time.character.character.get_character_location_as_tuple(test_character)
        actual = location[0]
    ...
    def test_get_character_location_as_tuple_initial_location(self):
        test_character = {"X-coordinate": 0, "Y-coordinate": 0, "Current HP": 5}
        actual = strands_of_time.character.character.get_character_location_as_tuple(test_character)
        expected = (0, 0)
        self.assertEqual(expected, actual)
